    ...
    <div>
       ...
       <div className=' flex  gap-12 mx-auto w-[90%] my-10 items-center shadow-2xl rounded-2xl bg-white px-6 py-10 max-tablet:flex-col max-mobile:px-3 max-mobile:w-[100%] max-mobile:my-7'>
        ...
        <div className=' w-[60%] flex flex-col text-start gap-4 text-[18px] max-tablet:w-[90%] max-mobile:text-[14px]'>
            ...
            <p className=' '>Waiting can be one of the hardest seasons of life, yet it’s often where God does His deepest work in you. The Waiting Well workbook is designed to help you understand God’s timing, strengthen your faith, and stay encouraged while you wait for the promises He has spoken over your life.</p>

  ...
  return (
    <div>
          <div className=" relative max-tablet:top-25 ">
                ...
                <div className=" absolute top-69 w-[45%] left-18 max-tablet:top-30 max-tablet:left-20 max-mobile:left-8 max-mobile:top-20 z-30">
                  <h1 className=" text-[55px] font-bold text-center leading-tight text-[#FAF8F2] z-30 animate-slideUp max-tablet:text-[28px] max-mobile:text-[18px]">Turning ideas into beautifully customized fillable digital journals</h1>
                  </div>
